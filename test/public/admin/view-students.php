...
$sql = "SELECT id, full_name, gender, class_course, contact_number, email, address, status, medium, comments_special_instructions, remarks, guardian_name FROM students";
